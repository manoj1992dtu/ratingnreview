...
interface StaticReviewCardProps {
  review: CompanyReview;
}

const StaticReviewCard: React.FC<StaticReviewCardProps> = ({ review }) => {
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:border-gray-300">
      {/* Header */}
      ...
      {/* Static helpful count display */}
      <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-100">
        <div className="flex items-center space-x-2 text-gray-600">
          <span className="text-sm font-medium">
            {/* {review.helpful_count ? `${review.helpful_count} people found this helpful` : 'Be the first to find this helpful'} */}
...
export default StaticReviewCard;